 ...
 *
 */
public class GenerateValueFilesLandscape {
    ...
    public GenerateValueFilesLandscape(int baseX, int baseY, String supportStr) {
        this.baseW = baseX;
        this.baseH = baseY;
    ...
    public static void main(String[] args) {
        ...
        new GenerateValueFilesLandscape(baseW, baseH, addition).generate();
    }
